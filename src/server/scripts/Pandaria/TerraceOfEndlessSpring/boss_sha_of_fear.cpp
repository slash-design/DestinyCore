...
class spell_toes_champion_of_light : public SpellScriptLoader
{
public:
    spell_toes_champion_of_light() : SpellScriptLoader("spell_toes_champion_of_light") { }

    class spell_toes_champion_of_light_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_champion_of_light_AuraScript);
        ...
        void Register()
        {
            AfterEffectApply += AuraEffectApplyFn(spell_toes_champion_of_light_AuraScript::OnApply, EFFECT_0, SPELL_AURA_MOD_SCALE, AURA_EFFECT_HANDLE_REAL);
            AfterEffectRemove += AuraEffectRemoveFn(spell_toes_champion_of_light_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_MOD_SCALE, AURA_EFFECT_HANDLE_REAL);
        }
    };


    class spell_toes_champion_of_light_Spellcript : public SpellScript
    {
        PrepareSpellScript(spell_toes_champion_of_light_Spellcript);
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_champion_of_light_Spellcript::SelectChampion, EFFECT_0, TARGET_UNIT_SRC_AREA_ENTRY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_champion_of_light_Spellcript();
    }

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_champion_of_light_AuraScript();
    }
};

// Breath of Fear - 119414 / 125786
class spell_toes_breath_of_fear : public SpellScriptLoader
{
public:
    spell_toes_breath_of_fear() : SpellScriptLoader("spell_toes_breath_of_fear") { }
...
class spell_toes_breath_of_fear_fear : public SpellScriptLoader
{
public:
    spell_toes_breath_of_fear_fear() : SpellScriptLoader("spell_toes_breath_of_fear_fear") {}

    class spell_toes_impl : public SpellScript
    {
        PrepareSpellScript(spell_toes_impl);
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_impl::CorrectRange, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_impl::CorrectRange, EFFECT_1, TARGET_UNIT_SRC_AREA_ENEMY);
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_impl::CorrectRange, EFFECT_2, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_impl();
    }
};


// Conjure Terror Spawn - 119108
class spell_toes_conjure_terror_spawn : public SpellScriptLoader
{
public:
    spell_toes_conjure_terror_spawn() : SpellScriptLoader("spell_toes_conjure_terror_spawn") { }

    class spell_toes_conjure_terror_spawn_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_conjure_terror_spawn_AuraScript);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_toes_conjure_terror_spawn_AuraScript::OnTick, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_conjure_terror_spawn_AuraScript();
    }
};

// Ominous Cackle - 119593, 119692, 119693
class spell_toes_ominous_caclke_target : public SpellScriptLoader
{
public:
    spell_toes_ominous_caclke_target() : SpellScriptLoader("spell_toes_ominous_caclke_target") {}
    ...
    class spell_toes_impl : public SpellScript
    {
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_impl::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            OnEffectHitTarget += SpellEffectFn(spell_toes_impl::ApplyMorph, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
...
class spell_toes_death_blossom : public SpellScriptLoader
{
    class spell_toes_impl : public SpellScript
    {
        PrepareSpellScript(spell_toes_impl);
...
public:
    spell_toes_death_blossom() : SpellScriptLoader("spell_toes_death_blossom") {}
...
// Dread Spray - 120047
class spell_toes_dread_spray : public SpellScriptLoader
{
public:
    spell_toes_dread_spray() : SpellScriptLoader("spell_toes_dread_spray") {}
...
class spell_toes_teleport_to_dread_expanse : public SpellScriptLoader
{
public:
    spell_toes_teleport_to_dread_expanse() : SpellScriptLoader("spell_toes_dread_expanse_tp") {}

    class spell_toes_teleport_to_dread_expanse_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_toes_teleport_to_dread_expanse_SpellScript);
        ...
        void Register()
        {
            OnHit += SpellHitFn(spell_toes_teleport_to_dread_expanse_SpellScript::HandleOnHit);
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_teleport_to_dread_expanse_SpellScript::SelectTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENTRY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_teleport_to_dread_expanse_SpellScript();
    }
};

class spell_toes_implacable_strike : public SpellScriptLoader
{
public:
    spell_toes_implacable_strike() : SpellScriptLoader("spell_toes_implacable_strike") {}
...
class npc_return_to_terrace : public CreatureScript
{
public:
    npc_return_to_terrace() : CreatureScript("npc_return_to_terrace") { }
...
public:
    ...
    class spell_transfer_light_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            AfterCast += SpellCastFn(spell_transfer_light_SpellScript::HandleAfterCast);
        }
    };
...
class spell_toes_ominous_cackle_immunities : public SpellScriptLoader
{
public:
    spell_toes_ominous_cackle_immunities() : SpellScriptLoader("spell_toes_ominous_cackle_immunities") { }

    class spell_toes_ominous_cackle_immunities_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_ominous_cackle_immunities_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_toes_ominous_cackle_immunities_AuraScript::OnApply, EFFECT_0, SPELL_AURA_TRANSFORM, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_toes_ominous_cackle_immunities_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_TRANSFORM, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_ominous_cackle_immunities_AuraScript();
    }
};

// Waterspout - 120519
class spell_toes_waterspout_periodic : public SpellScriptLoader
{
public:
    spell_toes_waterspout_periodic() : SpellScriptLoader("spell_toes_waterspout_periodic") { }

    class spell_toes_waterspout_periodic_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_waterspout_periodic_AuraScript);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_toes_waterspout_periodic_AuraScript::HandlePeriodicTick, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_waterspout_periodic_AuraScript();
    }
};

// Fearless - 118977
class spell_toes_fearless : public SpellScriptLoader
{
public:
    spell_toes_fearless() : SpellScriptLoader("spell_toes_fearless") { }

    class spell_toes_fearless_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_fearless_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_toes_fearless_AuraScript::OnApply, EFFECT_0, SPELL_AURA_MOD_DAMAGE_PERCENT_DONE, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_toes_fearless_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_MOD_DAMAGE_PERCENT_DONE, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_fearless_AuraScript();
    }
};

// Fearless - 136584
class spell_toes_fearless_pet : public SpellScriptLoader
{
public:
    spell_toes_fearless_pet() : SpellScriptLoader("spell_toes_fearless_pet") { }

    class spell_toes_fearless_pet_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_fearless_pet_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_toes_fearless_pet_AuraScript::OnApply, EFFECT_1, SPELL_AURA_MOD_SCALE, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_toes_fearless_pet_AuraScript::OnRemove, EFFECT_1, SPELL_AURA_MOD_SCALE, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_fearless_pet_AuraScript();
    }
};
...
void AddSC_boss_sha_of_fear()
{
    ...
    new spell_toes_champion_of_light();
    new spell_toes_breath_of_fear();
    new spell_toes_conjure_terror_spawn();
    new spell_toes_ominous_caclke_target();
    new npc_sha_of_fear_bowman();
    new spell_toes_dread_spray();
    new npc_sha_globe();
    new spell_toes_breath_of_fear_fear();
    new spell_toes_death_blossom();
    new spell_toes_teleport_to_dread_expanse();
    new npc_return_to_terrace();
    new npc_waterspout();
    new npc_dread_spawn();
    new spell_emerge();
    new spell_transfer_light();
    new spell_toes_ominous_cackle_immunities();
    new spell_toes_waterspout_periodic();
    new spell_toes_fearless();
    new spell_toes_fearless_pet();
}
