...
// Terrorize - 123018
class spell_toes_terrorize_periodic_player : public SpellScriptLoader
{
    class spell_toes_impl : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_toes_impl::HandleDummy, EFFECT_0, SPELL_EFFECT_SCHOOL_DAMAGE);
        }
    };

public:
    spell_toes_terrorize_periodic_player() : SpellScriptLoader("spell_toes_terrorize_periodic_player") {}
...
// 125843, jam spell ?
class spell_toes_dread_shadows_damage : public SpellScriptLoader
{
public:
    spell_toes_dread_shadows_damage() : SpellScriptLoader("spell_toes_dread_shadows_damage") { }

    class spell_toes_dread_shadows_damage_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_toes_dread_shadows_damage_SpellScript);
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_dread_shadows_damage_SpellScript::RemoveInvalidTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENTRY);
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_dread_shadows_damage_SpellScript::RemoveInvalidTargets, EFFECT_1, TARGET_UNIT_SRC_AREA_ENTRY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_dread_shadows_damage_SpellScript();
    }
};
...
// 122768
class spell_toes_dread_shadows_malus : public SpellScriptLoader
{
public:
    spell_toes_dread_shadows_malus() : SpellScriptLoader("spell_toes_dread_shadows_malus") { }

    class spell_toes_dread_shadows_malus_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_toes_dread_shadows_malus_SpellScript);
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_dread_shadows_malus_SpellScript::RemoveInvalidTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_dread_shadows_malus_SpellScript::RemoveInvalidTargets, EFFECT_1, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_dread_shadows_malus_SpellScript();
    }
};

// 122789
class spell_toes_sunbeam : public SpellScriptLoader
{
public:
    spell_toes_sunbeam() : SpellScriptLoader("spell_toes_sunbeam") { }

    class spell_toes_sunbeam_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_toes_sunbeam_SpellScript);
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_sunbeam_SpellScript::CheckTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ALLY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_sunbeam_SpellScript();
    }


    class spell_toes_sunbeam_aura_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_sunbeam_aura_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_toes_sunbeam_aura_AuraScript::OnApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_toes_sunbeam_aura_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_sunbeam_aura_AuraScript();
    }
};

// Day and Night regen auras - 122438 and 122453
class spell_toes_tsulong_sha_regen : public SpellScriptLoader
{
public:
    spell_toes_tsulong_sha_regen() : SpellScriptLoader("spell_toes_tsulong_sha_regen") {}
...
class spell_toes_tsulong_nightmares : public SpellScriptLoader
{
public:
    spell_toes_tsulong_nightmares() : SpellScriptLoader("spell_toes_tsulong_nightmares") {}
...
class spell_toes_tsulong_terrorize : public SpellScriptLoader
{
public:
    spell_toes_tsulong_terrorize() : SpellScriptLoader("spell_toes_tsulong_terrorize") {}
    ...
    class spell_toes_impl : public SpellScript
    {
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_impl::SelectTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };
...
class npc_the_light_of_day : public CreatureScript
{
public:
    npc_the_light_of_day() : CreatureScript("npc_the_light_of_day") { }
...
class spell_the_light_of_day : public SpellScriptLoader
{
public:
    spell_the_light_of_day() : SpellScriptLoader("spell_the_light_of_day") { }

    class spell_the_light_of_day_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_the_light_of_day_AuraScript);
        ...
        void Register()
        {
            DoEffectCalcPeriodic += AuraEffectCalcPeriodicFn(spell_the_light_of_day_AuraScript::CalcPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_the_light_of_day_AuraScript();
    }
};

// Unstable Bolt - 122881
class spell_unstable_bolt_selfdamage : public SpellScriptLoader
{
public:
    spell_unstable_bolt_selfdamage() : SpellScriptLoader("spell_unstable_bolt_selfdamage") { }

    class spell_unstable_bolt_selfdamage_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_unstable_bolt_selfdamage_SpellScript);
        ...
        void Register()
        {
            AfterCast += SpellCastFn(spell_unstable_bolt_selfdamage_SpellScript::HandleDamage);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_unstable_bolt_selfdamage_SpellScript(); 
    }
};
...
void AddSC_boss_tsulong()
{
    new boss_tsulong();
    new npc_sunbeam();
    new spell_toes_dread_shadows_damage();
    new spell_toes_dread_shadows_malus();
    new spell_toes_sunbeam();
    new spell_toes_tsulong_sha_regen();
    new spell_toes_terrorize_periodic_player();
    new spell_toes_tsulong_terrorize();
    new spell_toes_tsulong_nightmares();
    new npc_embodied_terror();
    new npc_fright_spawn();
    new npc_unstable_sha();
    new npc_dark_of_night();
    new npc_the_light_of_day();
    new spell_the_light_of_day();
    new spell_unstable_bolt_selfdamage();
}
