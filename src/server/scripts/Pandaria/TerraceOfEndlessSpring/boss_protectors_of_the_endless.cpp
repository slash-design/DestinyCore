...
class spell_toes_defiled_ground_damage : public SpellScriptLoader
{
public:
    spell_toes_defiled_ground_damage() : SpellScriptLoader("spell_toes_defiled_ground_damage") { }

    class spell_toes_defiled_ground_damage_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_toes_defiled_ground_damage_SpellScript);
        ...
        void Register()
        {
            OnHit += SpellHitFn(spell_toes_defiled_ground_damage_SpellScript::DealDamage);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_defiled_ground_damage_SpellScript();
    }
};

// Expelled Corruption (triggered) - 117955
class spell_toes_expelled_corruption : public SpellScriptLoader
{
public:
    spell_toes_expelled_corruption() : SpellScriptLoader("spell_toes_expelled_corruption") { }

    class spell_toes_expelled_corruption_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_toes_expelled_corruption_SpellScript);
        ...
        void Register()
        {
            OnHit += SpellHitFn(spell_toes_expelled_corruption_SpellScript::DealDamage);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_expelled_corruption_SpellScript();
    }
};

// Lightning Storm - 118064, 118040, 118053, 118054, 118055, 118077
class spell_toes_lightning_storm_aura : public SpellScriptLoader
{
public:
    spell_toes_lightning_storm_aura() : SpellScriptLoader("spell_toes_lightning_storm_aura") { }

    class spell_toes_lightning_storm_aura_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_lightning_storm_aura_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_toes_lightning_storm_aura_AuraScript::OnApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_toes_lightning_storm_aura_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_lightning_storm_aura_AuraScript();
    }
};

// Lightning Storm (damage) - 118004, 118005, 118007, 118008
class spell_toes_lightning_storm_damage : public SpellScriptLoader
{
public:
    spell_toes_lightning_storm_damage() : SpellScriptLoader("spell_toes_lightning_storm_damage") { }

    class spell_toes_lightning_storm_damage_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_toes_lightning_storm_damage_SpellScript);
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_lightning_storm_damage_SpellScript::CorrectRange, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_lightning_storm_damage_SpellScript();
    }
};

// Lightning Prison - 111850
class spell_toes_lightning_prison : public SpellScriptLoader
{
public:
    spell_toes_lightning_prison() : SpellScriptLoader("spell_toes_lightning_prison") { }

    class spell_toes_lightning_prison_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_toes_lightning_prison_SpellScript);
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_lightning_prison_SpellScript::CorrectRange, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_lightning_prison_SpellScript();
    }
};

// Corrupted Essence - 118191
class spell_toes_corrupted_essence : public SpellScriptLoader
{
public:
    spell_toes_corrupted_essence() : SpellScriptLoader("spell_toes_corrupted_essence") { }

    class spell_toes_corrupted_essence_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_corrupted_essence_AuraScript);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_toes_corrupted_essence_AuraScript::OnTick, EFFECT_1, SPELL_AURA_PERIODIC_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_corrupted_essence_AuraScript();
    }

    class spell_toes_corrupted_essence_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_toes_corrupted_essence_SpellScript);
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_corrupted_essence_SpellScript::CorrectRange, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_corrupted_essence_SpellScript();
    }
};

// Superior Corrupted Essence - 117905
class spell_toes_superior_corrupted_essence : public SpellScriptLoader
{
public:
    spell_toes_superior_corrupted_essence() : SpellScriptLoader("spell_toes_superior_corrupted_essence") { }

    class spell_toes_superior_corrupted_essence_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_superior_corrupted_essence_AuraScript);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_toes_superior_corrupted_essence_AuraScript::OnTick, EFFECT_1, SPELL_AURA_PERIODIC_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_superior_corrupted_essence_AuraScript();
    }
};

// Cleansing Waters - 117283
class spell_toes_cleansing_waters_regen : public SpellScriptLoader
{
public:
    spell_toes_cleansing_waters_regen() : SpellScriptLoader("spell_toes_cleansing_waters_regen") { }

    class spell_toes_cleansing_waters_regen_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_toes_cleansing_waters_regen_SpellScript);
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_cleansing_waters_regen_SpellScript::CorrectTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENTRY);
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_cleansing_waters_regen_SpellScript::CorrectTargets, EFFECT_1, TARGET_UNIT_SRC_AREA_ENTRY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_cleansing_waters_regen_SpellScript();
    }
};
...
void AddSC_boss_protectors_of_the_endless()
{
    ...
    new spell_toes_defiled_ground_damage();
    new spell_toes_expelled_corruption();
    new spell_toes_lightning_storm_aura();
    new spell_toes_lightning_storm_damage();
    new spell_toes_lightning_prison();
    new spell_toes_corrupted_essence();
    new spell_toes_superior_corrupted_essence();
    new spell_toes_cleansing_waters_regen();
}
