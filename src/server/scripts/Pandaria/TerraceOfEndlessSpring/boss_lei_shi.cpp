            ...
            case ACTION_ANIMATED_PROTECTOR_DIED:
            {
                ...
                for (auto itr : animatedProtectors)
                {
                    if (Creature* elemental = me->FindNearestCreature(NPC_ANIMATED_PROTECTOR, 500.0f))
                    {
                        ...
                        elemental->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE);
                        elemental->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE);
                        elemental->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_PC);
                    }
                }
...
// Get Away ! - 123461
class spell_toes_get_away : public SpellScriptLoader
{
public:
    spell_toes_get_away() : SpellScriptLoader("spell_toes_get_away") { }

    class spell_toes_get_away_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_get_away_AuraScript);
        ...
        void Register()
        {
            AfterEffectRemove += AuraEffectRemoveFn(spell_toes_get_away_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_get_away_AuraScript();
    }
};

// Hide - 123244
class spell_toes_hide : public SpellScriptLoader
{
public:
    spell_toes_hide() : SpellScriptLoader("spell_toes_hide") { }

    class spell_toes_hide_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_hide_AuraScript);
        ...
        void Register()
        {
            AfterEffectApply += AuraEffectApplyFn(spell_toes_hide_AuraScript::OnApply, EFFECT_1, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
            AfterEffectRemove += AuraEffectRemoveFn(spell_toes_hide_AuraScript::OnRemove, EFFECT_1, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_hide_AuraScript();
    }
};

// Get Away damage - 123467
class spell_toes_get_away_dmg : public SpellScriptLoader
{
public:
    spell_toes_get_away_dmg() : SpellScriptLoader("spell_toes_get_away_dmg") {}
    ...
    class spell_toes_impl : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_toes_impl::ModifyDamage, EFFECT_0, SPELL_EFFECT_SCHOOL_DAMAGE);
        }
    };
...
// Hide (stacks) - 123233
class spell_toes_hide_stacks : public SpellScriptLoader
{
public:
    spell_toes_hide_stacks() : SpellScriptLoader("spell_toes_hide_stacks") { }

    class spell_toes_hide_stacks_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_hide_stacks_AuraScript);
        ...
        void Register()
        {
            OnEffectRemove += AuraEffectRemoveFn(spell_toes_hide_stacks_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_hide_stacks_AuraScript();
    }
};

// Scary Fog (DoT) - 123705
class spell_toes_scary_fog_dot : public SpellScriptLoader
{
public:
    spell_toes_scary_fog_dot() : SpellScriptLoader("spell_toes_scary_fog_dot") { }

    class spell_toes_scary_fog_dot_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_toes_scary_fog_dot_SpellScript);
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_toes_scary_fog_dot_SpellScript::CorrectRange, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_toes_scary_fog_dot_SpellScript();
    }

    class spell_toes_scary_fog_dot_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_toes_scary_fog_dot_AuraScript);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_toes_scary_fog_dot_AuraScript::OnTick, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_toes_scary_fog_dot_AuraScript();
    }
};
...
void AddSC_boss_lei_shi()
{
    ...
    new spell_toes_get_away();
    new spell_toes_get_away_dmg();
    new spell_toes_hide();
    new spell_toes_hide_stacks();
    new spell_toes_scary_fog_dot();
}
