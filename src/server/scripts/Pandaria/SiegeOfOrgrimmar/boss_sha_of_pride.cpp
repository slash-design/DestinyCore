    ...
    public:
        ...
        struct npc_sha_of_pride_ethereal_corruptionAI : public ScriptedAI
        {
            npc_sha_of_pride_ethereal_corruptionAI(Creature* creature) : ScriptedAI(creature)
            {
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UnitFlags::UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_NOT_SELECTABLE | UnitFlags::UNIT_FLAG_IMMUNE_TO_PC);
            }
        ...
        private:
            ...
            void DoUniqueEffectsOnUnit(Unit* target)
            {
                ...
                else if (currentPride >= 50 && currentPride < 75)
                {
                    ...
                    target->GetFirstCollisionPosition(/*l_MissilePos,*/ frand(10.f, 15.f), frand(0.f, 2.f * M_PI));
