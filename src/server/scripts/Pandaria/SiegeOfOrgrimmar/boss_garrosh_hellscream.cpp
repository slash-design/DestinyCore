    ...
    public:
        ...
        struct boss_garrosh_hellscreamAI : public BossAI
        {
                ...
                m_OrcsSpawner(creature), m_YShaarjHelper(creature), m_EnergyRegenerator(creature)
            {
                ...
                me->SetFloatValue(UNIT_FIELD_BOUNDINGRADIUS, 1.085f);
                me->SetFloatValue(UNIT_FIELD_COMBATREACH, 6.3f);
            ...
            void UpdateScale()
            {
                if (me->GetHealth() > 0)
                {
                    ...
                    if (AreaTrigger* pAreaTrigger = me->GetAreaTrigger(IsEmpowered() ? SPELL_EMPOWERED_DESECRATED_WEAPON_VISUAL : SPELL_DESECRATED_WEAPON_VISUAL))
                    {
                        ...
                        pAreaTrigger->SetFloatValue(MAX_AREATRIGGER_SCALE, scale);
                    }
...
class npc_garrosh_hellscream_farseer_wolf_rider : public CreatureScript
{
    public:
        ...
        struct npc_garrosh_hellscream_farseer_wolf_riderAI : public OrcAI
        {
            ...
            void Reset() override
            {
                me->SetUInt32Value(UNIT_FIELD_MOUNTDISPLAYID, 50726);
    ...
    public:
        ...
        class spell_garrosh_hellscream_touch_of_yshaarj_AuraScript : public AuraScript
        {
            ...
            void HandleApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                m_OldFlag = GetUnitOwner()->HasFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_PVP_ATTACKABLE);

                GetUnitOwner()->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_PVP_ATTACKABLE);

                GetUnitOwner()->SetFlag(UNIT_FIELD_FLAGS, UnitFlags::UNIT_FLAG_PACIFIED);
            ...
            void HandleRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                if (m_OldFlag)
                    GetUnitOwner()->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_PVP_ATTACKABLE);

                GetUnitOwner()->RemoveFlag(UNIT_FIELD_FLAGS, UnitFlags::UNIT_FLAG_PACIFIED);
            }
