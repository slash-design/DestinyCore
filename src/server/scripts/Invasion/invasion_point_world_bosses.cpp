...
class spell_slimbering_gasp : public AuraScript
{
    ...
    void Register() override
    {
        OnEffectRemove += AuraEffectRemoveFn(spell_slimbering_gasp::OnRemove, EFFECT_1, SPELL_AURA_AREA_TRIGGER, AURA_EFFECT_HANDLE_REAL);
    }
};
...
class spell_enter_rift : public SpellScript
{
    ...
    SpellCastResult CheckCast()
    {
        if (Player* player = GetCaster()->ToPlayer())
        {
            ...
            {
                // Hole das WorldQuestTemplate für Quest 48982
                if (WorldQuestTemplate const* wqTemplate = sWorldQuestMgr->GetWorldQuestTemplate(48982))
                {
                    // Wenn die WorldQuest noch nicht abgeschlossen ist und der Spieler das Achievement 12085 hat
            ...
            {
                if (WorldQuestTemplate const* wqTemplate = sWorldQuestMgr->GetWorldQuestTemplate(49099))
                {
            ...
            {
                if (WorldQuestTemplate const* wqTemplate = sWorldQuestMgr->GetWorldQuestTemplate(49096))
                {
            ...
            {
                if (WorldQuestTemplate const* wqTemplate = sWorldQuestMgr->GetWorldQuestTemplate(49091))
                {
            ...
            {
                if (WorldQuestTemplate const* wqTemplate = sWorldQuestMgr->GetWorldQuestTemplate(49098))
                {
            ...
            {
                if (WorldQuestTemplate const* wqTemplate = sWorldQuestMgr->GetWorldQuestTemplate(49097))
                {
    ...
    void HandleScript(SpellEffIndex /*effIndex*/)
    {
        ...
        else if (player->GetCurrentZoneID() == 9180)
        {
            ...
            else if (sGameEventMgr->IsActiveEvent(125))
        ...
        else if (player->GetCurrentZoneID() == 9100)
        {
            ...
            else if (sGameEventMgr->IsActiveEvent(124))
        ...
        else if (player->GetCurrentZoneID() == 9126)
        {
            ...
            else if (sGameEventMgr->IsActiveEvent(122))
        ...
        else if (player->GetCurrentZoneID() == 9127)
        {
            ...
            else if (sGameEventMgr->IsActiveEvent(121))
        ...
        else if (player->GetCurrentZoneID() == 9102)
        {
            ...
            else if (sGameEventMgr->IsActiveEvent(120))
        ...
        else if (player->GetCurrentZoneID() == 9128)
        {
            ...
            else if (sGameEventMgr->IsActiveEvent(127))
