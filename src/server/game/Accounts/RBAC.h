...
enum RBACPermissions
{
	...
	RBAC_PREM_COMMAND_PBOTACCOUNT_LOGINALL                   = 1502,
	RBAC_PREM_COMMAND_PBOTACCOUNT_BOTCREATE                  = 1503,
	RBAC_PREM_COMMAND_PBOTAI                                 = 1504,
	RBAC_PREM_COMMAND_PBOTAI_MOVETO                          = 1505,
	RBAC_PREM_COMMAND_PBOTAI_MOVEPOINTS                      = 1506,
	RBAC_PREM_COMMAND_PBOTACCOUNT_LOGOUTALL                  = 1507,
	RBAC_PREM_COMMAND_PBOTACCOUNT_RESETLEVEL                 = 1508,
	RBAC_PREM_COMMAND_PBOTAI_ADD_AIWP                        = 1509,
	RBAC_PREM_COMMAND_PBOTAI_DEL_AIWP                        = 1510,
	RBAC_PREM_COMMAND_PBOTAI_MOV_AIWP                        = 1511,
	RBAC_PREM_COMMAND_PBOTAI_SHOWALL_AIWP                    = 1512,
	RBAC_PREM_COMMAND_PBOTAI_END_BG                          = 1513,
	RBAC_PREM_COMMAND_PBOTAI_POINTSDESC                      = 1514,
	RBAC_PREM_COMMAND_PBOTACCOUNT_LOGINCLASSES               = 1515,
	RBAC_PREM_COMMAND_PBOTAI_FACETO                          = 1516,
	RBAC_PREM_COMMAND_PBOTAI_DEBUGTARGET                     = 1517,
	RBAC_PREM_COMMAND_PBOTAI_SEARCH                          = 1518,
	RBAC_PREM_COMMAND_PBOTAI_TELEPORT                        = 1519,
	RBAC_PREM_COMMAND_PBOTAI_ABFLAG                          = 1520,
	RBAC_PREM_COMMAND_PBOTAI_FINDGO                          = 1521,
	RBAC_PREM_COMMAND_PBOTAI_ECP                             = 1522,
	RBAC_PREM_COMMAND_PBOTAI_RESETPVPEQUIP                   = 1523,
