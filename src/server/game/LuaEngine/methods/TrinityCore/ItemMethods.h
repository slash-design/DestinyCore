...
namespace LuaItem
{
    ...
    {
        // STUBBED: Item::IsWeaponVellum not in Legion (merged into IsVellum)
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: ItemTemplate Name1/ItemId/Quality accessors changed in Legion
        E->CHECKVAL<uint8>(2, DEFAULT_LOCALE);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: MAX_ITEM_PROTO_SPELLS / Effects[] not present in Legion ItemTemplate
        E->CHECKVAL<uint32>(2);
        E->Push();
        return 1;
    }
    ...
    */
    ...
    {
        // STUBBED: DisplayInfoID not directly accessible on Legion ItemTemplate
        E->Push();
        return 1;
    }
    ...
    */
    ...
    {
        // STUBBED: Flags[] array not present on Legion ItemTemplate
        E->Push();
        return 1;
    }
    ...
    */
    ...
    {
        // STUBBED: ItemLevel accessor changed in Legion (uses BaseItemLevel + bonuses)
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: RequiredLevel accessor differs in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: StatsCount accessor not in Legion ItemTemplate
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: ItemStat[] / StatsCount accessors not in Legion ItemTemplate
        E->CHECKVAL<uint8>(2);
        E->Push(0);
        E->Push(0);
        return 2;
    ...
    {
        // STUBBED: MAX_ITEM_PROTO_DAMAGES / Damage[] not present in Legion ItemTemplate
        E->CHECKVAL<uint8>(2);
        E->Push(0);
        E->Push(0.0f);
        E->Push(0.0f);
    ...
    {
        // STUBBED: ItemTemplate::GetArmor(itemLevel) signature requires item level in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Item::SetItemRandomProperties expects ItemRandomEnchantmentId const& in Legion
        E->CHECKVAL<uint32>(2);
        return 0;
    }
