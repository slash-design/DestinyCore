...
namespace LuaSpell
{
    ...
    {
        // STUBBED: Spell::GetPowerCost returns std::vector in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Spell::IsPositive not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Spell::GetRuneState not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: GetUnitTargetCountForEffect not available in Legion
        E->CHECKVAL<uint8>(2);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: GetGameObjectTargetCountForEffect not available in Legion
        E->CHECKVAL<uint8>(2);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: GetItemTargetCountForEffect not available in Legion
        E->CHECKVAL<uint8>(2);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Spell::CalculateDamage signature differs in Legion
        E->CHECKVAL<uint8>(2);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Spell::SetRuneState not available in Legion
        E->CHECKVAL<uint8>(2);
        return 0;
    }
