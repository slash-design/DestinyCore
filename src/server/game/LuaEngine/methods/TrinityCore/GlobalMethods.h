...
namespace LuaGlobalFunctions
{
    ...
    {
        // STUBBED: HashMapHolder uses boost::shared_mutex on Legion (incompatible with std::shared_lock)
        lua_newtable(E->L);
        return 1;
    }
    ...
    {
        // STUBBED: ObjectGuid::Create<HighGuid::GameObject> signature changed in Legion (requires mapId)
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: ObjectGuid::Create<HighGuid::Creature> signature changed in Legion (requires mapId)
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: ItemTemplate accessors changed in Legion
    ...
    {
        // STUBBED: CliCommandHolder Print signature differs on Legion (const char* not std::string_view)
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: HighGuid::Unit / GenerateLowGuid / GameObjectData lookups differ on Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: ObjectMgr::AddVendorItem signature changed in Legion
        E->Push();
        return 1;
    }
    ...
    int VendorRemoveItem(Eluna* E)
    {
        ...
        eObjectMgr->RemoveVendorItem(entry, item, 0, true);
    ...
    int VendorRemoveAllItems(Eluna* E)
    {
        ...
        for (auto itr = itemlist.begin(); itr != itemlist.end(); ++itr)
            eObjectMgr->RemoveVendorItem(entry, itr->item, 0, true);
    ...
    int Kick(Eluna* E)
    {
        ...
        // STUBBED: WorldSession::KickPlayer takes no argument on Legion
    ...
    {
        // STUBBED: ItemTemplate::MaxCount, MailSender ctor, ObjectAccessor::FindPlayerByLowGUID differ on Legion
        E->Push();
        return 1;
    }
