...
namespace LuaCreature
{
    ...
    {
        // STUBBED: Creature::CanRegenerateHealth not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Creature::SetRegenerateHealth not available in Legion
    ...
    {
        // STUBBED: Creature::GetWanderDistance not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Creature::GetCurrentWaypointInfo not available in Legion
        E->Push();
        return 1;
    }
    ...
    */
    ...
    {
        // STUBBED: ThreatReference/GetSortedThreatList not available in Legion
        E->CHECKVAL<uint32>(2);
        E->CHECKVAL<bool>(3, false);
        E->CHECKVAL<uint32>(4, 0);
        E->CHECKVAL<float>(5, 0.0f);
    ...
    {
        // STUBBED: Legion ThreatManager API differs
        E->Push((double)0);
        return 1;
    }
    ...
    {
        // STUBBED: Creature::GetShieldBlockValue not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Creature::SetWanderDistance not available in Legion
        E->CHECKVAL<float>(2);
        return 0;
    }
