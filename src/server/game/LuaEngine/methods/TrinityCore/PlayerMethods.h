...
namespace LuaPlayer
{
    ...
    {
        // STUBBED: Player::CanTitanGrip(Item*) overload not available in Legion
        E->CHECKOBJ<Item>(2);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: MAX_TALENT_GROUPS / HasTalent signature differs in Legion
        E->CHECKVAL<uint32>(2);
        E->CHECKVAL<uint8>(3);
        E->Push();
        return 1;
    ...
    {
        // STUBBED: WorldSession::CanSpeak not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // Arena Team system removed since MoP - always returns false on Legion+
        E->CHECKVAL<uint32>(2); // consume the type argument from Lua stack
        E->Push(false);
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetRestBonus not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: IsNeverVisible signature differs in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetTalentGroupsCount not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetPhaseMaskForSpawn not available in Legion (PhaseShift)
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetArenaPoints not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetHonorPoints not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetShieldBlockValue not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetXPRestBonus not available in Legion
        E->CHECKVAL<uint32>(2);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetManaBonusFromIntellect not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetDifficulty(bool) not available in Legion
        E->CHECKVAL<bool>(2, true);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetFreeTalentPoints not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetComboTarget not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetChatTag not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetXP not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::GetXPForNextLevel not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::SetFreeTalentPoints not available in Legion
        E->CHECKVAL<uint32>(2);
        return 0;
    }
    ...
    {
        // STUBBED: Player::SetRestBonus not available in Legion
        E->CHECKVAL<float>(2);
        return 0;
    }
    ...
    {
        // STUBBED: Player::SetArenaPoints not available in Legion
        E->CHECKVAL<uint32>(2);
        return 0;
    }
    ...
    {
        // STUBBED: Player::SetHonorPoints not available in Legion
        E->CHECKVAL<uint32>(2);
        return 0;
    }
    ...
    {
        // STUBBED: Player::SetPvpFlag/RemovePvpFlag not available in Legion
        E->CHECKVAL<bool>(2, true);
        (void)UNIT_BYTE2_FLAG_FFA_PVP;
        return 0;
    }
    ...
    {
        // STUBBED: Player::ResetPetTalents not available in Legion
        return 0;
    }
    ...
    {
        ObjectGuid guid = E->CHECKVAL<ObjectGuid>(2, player->GetGUID());
    ...
    {
        // STUBBED: Player::ModifyArenaPoints not available in Legion
        E->CHECKVAL<int32>(2);
        return 0;
    }
    ...
    {
        // STUBBED: Player::ModifyHonorPoints not available in Legion
        E->CHECKVAL<int32>(2);
        return 0;
    }
    ...
    int SendAuctionMenu(Eluna* E, Player* player)
    {
        ...
        player->GetSession()->SendAuctionHello(unit->GetGUID(), unit->ToCreature());
        return 0;
    }
    ...
    {
        // STUBBED: SendTrainerList signature changed in Legion (requires trainerId)
    ...
    {
        // STUBBED: BoundInstancesMap structure changed in Legion (nested map by Difficulty)
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: Player::ResetTalentsCost not available in Legion
        E->Push();
        return 1;
    }
    ...
    int AddComboPoints(Eluna* E, Player* player)
    {
        ...
        player->AddComboPoints(count, nullptr);
        return 0;
    }
    ...
    {
        // STUBBED: Quest API diverged in Legion - RequiredItemId/Count, RequiredNpcOrGo/Count,
        // QUEST_ITEM_OBJECTIVES_COUNT, QUEST_OBJECTIVES_COUNT, GetRepObjectiveFaction/Value,
        // GetRewOrReqMoney no longer exist; objectives moved to QuestObjective array.
        uint32 entry = E->CHECKVAL<uint32>(2);
        (void)entry;
        E->Push();
        return 1;
    ...
    int RemoveQuest(Eluna* E, Player* player)
    {
        ...
        Quest const* questEntry = sObjectMgr->GetQuestTemplate(entry);
        if (questEntry)
            player->RemoveActiveQuest(questEntry, false);
    ...
    int EquipItem(Eluna* E, Player* player)
    {
        ...
        if (!item)
        {
            ...
            // STUBBED: Player::UpdateAchievementCriteria signature differs in Legion
            (void)entry;
        }
        else
        {
    ...
    {
        // STUBBED: Player::UpdateWeaponsSkillsToMaxSkillsForLevel not available in Legion
        return 0;
    }
    ...
    int SendQuestTemplate(Eluna* E, Player* player)
    {
        ...
        player->PlayerTalkClass->SendQuestGiverQuestDetails(quest, player->GetGUID(), activateAccept, true);
        return 0;
    }
    ...
    {
        // STUBBED: AddTalent/MAX_TALENT_GROUPS signature differs in Legion
        E->CHECKVAL<uint32>(2);
        E->CHECKVAL<uint8>(3);
        E->CHECKVAL<bool>(4, true);
        E->Push();
    ...
    int RemoveActiveQuest(Eluna* E, Player* player)
    {
        ...
        Quest const* questEntry = sObjectMgr->GetQuestTemplate(entry);
        if (questEntry)
            player->RemoveActiveQuest(questEntry);
        return 0;
    }
