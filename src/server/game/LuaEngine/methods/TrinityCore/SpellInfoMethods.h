...
namespace LuaSpellInfo
{
    ...
    {
        E->Push(spellInfo->GetSpellInfo()->AuraInterruptFlags[0]);
        return 1;
    }
    ...
    {
        E->Push(spellInfo->GetSpellInfo()->ChannelInterruptFlags[0]);
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::PowerType not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::ManaCost not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::ManaCostPerlevel not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::ManaPerSecond not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::ManaPerSecondPerLevel not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::ManaCostPercentage not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::RuneCostID not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::SpellVisual is no longer an indexable array in Legion
        E->CHECKVAL<uint32>(2);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::SpellIconID not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::ActiveIconID not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::Priority not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::GetMaxTicks requires a difficulty arg in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: GetEffectMechanic takes 2 args (effIndex, difficulty) in Legion
        E->CHECKVAL<uint32>(2);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: IsPassiveStackableWithRanks requires difficulty arg in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: IsAffectingArea requires difficulty arg in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: IsTargetingArea requires difficulty arg in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::IsSelfCast not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::IsProfessionOrRiding not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::IsAbilityLearnedWithProfession not available in Legion
        E->Push();
        return 1;
    }
    ...
    {
        SpellEffectName effect = static_cast<SpellEffectName>(E->CHECKVAL<uint32>(2));
    ...
    {
        // STUBBED: SpellInfo::HasAura requires difficulty arg in Legion
        E->CHECKVAL<uint32>(2);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::IsAffected and flag96 not available in Legion
        E->CHECKVAL<uint32>(2);
        E->CHECKVAL<uint32>(3);
        E->CHECKVAL<uint32>(4);
        E->CHECKVAL<uint32>(5);
    ...
    {
        // STUBBED: NeedsToBeTriggeredByCaster requires difficulty arg in Legion
        E->CHECKOBJ<ElunaSpellInfo>(2);
        E->Push();
        return 1;
    }
    ...
    {
        // STUBBED: SpellInfo::CheckTarget takes Unit (not WorldObject) in Legion
        E->CHECKOBJ<WorldObject>(2);
        E->CHECKOBJ<WorldObject>(3);
        E->Push();
        return 1;
    }
    ...
    int GetEffectPointsPerComboPoint(Eluna* E, ElunaSpellInfo* spellInfo)
    {
        ...
        if (effIndex >= MAX_SPELL_EFFECTS)
            return luaL_argerror(E->L, 2, "effect index out of range");
        E->Push(spellInfo->GetSpellInfo()->GetEffect(static_cast<SpellEffIndex>(effIndex))->PointsPerResource);
        return 1;
    }
    ...
    int EffectIsEffectType(Eluna* E, ElunaSpellInfo* spellInfo)
    {
        ...
        if (effIndex >= MAX_SPELL_EFFECTS)
            return luaL_argerror(E->L, 2, "effect index out of range");
        SpellEffectName effect = static_cast<SpellEffectName>(E->CHECKVAL<uint32>(3));
