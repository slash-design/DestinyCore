...
#include "SQLStorages.h"
#endif  // ELUNA_TRINITY
#if ELUNA_EXPANSION > EXP_CLASSIC && !defined(ELUNA_TRINITY)
// Legion (and modern TC) has no ArenaTeam.h - arena system reworked since MoP
#include "ArenaTeam.h"
#endif
...
#if !defined ELUNA_MANGOS
#if ELUNA_EXPANSION > EXP_CLASSIC
typedef OpcodeClient OpcodesList;
#endif
#endif
